...
def compile_button_clicked(code_editor, quadraples_editor, semantic_error_editor, Symbol_Table_code_editor, generate_button):
    ...
    generate_file(code_editor.toPlainText(), quadraples_editor, semantic_error_editor, Symbol_Table_code_editor)
...
def generate_file(code,quadraples_editor, semantic_error_editor, Symbol_Table_code_editor):
    with open("test.txt", "w") as file:
        file.write(code)
    subprocess.run(["make", "-f", "Makefile"])
    quadraples_editor.setPlainText(read_file("quadruple.txt"))
    semantic_error_editor.setPlainText(read_file("semantic-error.txt"))
    Symbol_Table_code_editor.setPlainText(read_file("symbol-tables.txt"))
...
def window():
    ...
    generate_button.clicked.connect(lambda: compile_button_clicked(code_editor, quadraples_editor, semantic_error_editor, Symbol_Table_code_editor, generate_button))
